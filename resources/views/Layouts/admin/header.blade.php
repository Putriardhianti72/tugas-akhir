                    ...
                    <div class="dropdown-menu quick-actions quick-actions-info animated fadeIn">
                        ...
                        <div class="quick-actions-scroll scrollbar-outer">
                            <div class="quick-actions-items">
                                <div class="row m-0">
                                    <a class="col-6 col-md-4 p-0" href="{{route('admin.sales-recap.index')}}">
                                        <div class="quick-actions-item">
                                            <i class="flaticon-file-1"></i>
                                            <span class="text">Rekap Penjualan</span>
                                        </div>
                                    </a>
                                    ...
                                    <a class="col-6 col-md-4 p-0" href="{{route('admin.retail-orders.index')}}">
                                        <div class="quick-actions-item">
                                            <i class="flaticon-file"></i>
                                            <span class="text">Retail Order List</span>
                                        </div>
                                    </a>
                                </div>
                            </div>
