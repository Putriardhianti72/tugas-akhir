                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-button-action">
                                                    ...
                                                    <a href="{{ route('banks.edit', $databank->id) }}" button type="button"  data-toggle="tooltip" title="" class="btn btn-link btn-primary btn-lg"  data-original-title="Edit Task">
                                                    ...
                                                    <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{route('banks.destroy', $databank['id'])}}" method="post">
                                                        @csrf
                                                        @method('DELETE')
