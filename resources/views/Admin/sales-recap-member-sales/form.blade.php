...
<div class="content">
    <div class="page-inner">
        ...
        <div class="row">
            <div class="col-md-12">
                <form action="{{ $retailReward->exists ? route('admin.retail-rewards.update', ['retail_order' => $retailReward->id]) : route('admin.retail-rewards.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="form-group form-group-default">
                                ...
                                <input id="code" name="code" type="text" class="form-control @error('code') is-invalid @enderror" value="{{ old('code', $retailReward->code)  }}">
                            </div>
                            @error('code')
