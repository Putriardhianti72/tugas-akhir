                    ...
                    <div class="card">
                        <div class="card-header">
                            <div class="d-flex align-items-center">
                                ...
                                {{--                            <a type="button" href="{{ route('admin.products.create') }}"  class="btn btn-primary btn-round ml-auto" data-toggle="modal">--}}
                                {{--                                Tambah Data Produk--}}
                                {{--                            </a>--}}
                                <a href="{{ route('admin.products.create') }}" class="btn btn-primary btn-round ml-auto">Tambah data produk</a>
                            ...
                            <div class="table-responsive">
                                <table id="add-row" class="display table table-striped table-hover" >
                                    ...
                                    @foreach($products as $product)
                                        <tr>
                                            <td>{{$i++}}</td>
                                            <td><img src="{{ asset('public/pict/' . $product->pict) }}" class="rounded" style="width: 150px"></td>
