                ...
                <div class="col-md-12">
                    ...
                    <form action="{{ route('products.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group form-group-default">
                            ...
                            <input id="product_name" name="product_name" @error('product_name') is-invalid @enderror" type="text" class="form-control" >
                        </div>
                        @error('product_name')
...
{{--                        {{ $categories }}--}}
            ...
            0                   @foreach($categories as $id => $category)
                        ...
                        <div class="form-group form-group-default">
                            ...
                            <input id="desc" name="desc" @error('desc') is-invalid @enderror" type="textarea" class="form-control" >
                        </div>
                        @error('desc')
                        <div class="alert alert-danger mt-2">
                            {{ $message }}
                        ...
                        <div class="form-group form-group-default">
                            ...
                            <input id="price" name="price" @error('price') is-invalid @enderror" type="textarea" class="form-control" >
                        </div>
                        @error('price')
                        <div class="alert alert-danger mt-2">
                            {{ $message }}
