    ...
    @include('Layouts.header')
        <div class="main-content" id="cart">
            ...
            {{--                                            @foreach($cart as $cart_item)--}}
                                                        ...
                                                        <input type="hidden" name="products[{{ $i }}][id]" value="{{ $cart[$i]['id']}}">
                                                        <li class="cart-item">
                                                                ...
                                                                <div class="product-line-grid-right product-line-actions col-md-4">
                                                                    <div class="row">
                                                                        <div class="col-md-10 col qty">
                                                                            <input type="text" name="products[{{ $i }}][domain]" class="form-control form-control-sm" placeholder="Domain" data-cart-input="domain" data-cart-id="{{ $cart[$i]['id'] }}" aria-label="Domain" aria-describedby="basic-addon2" autocomplete="off" required>
