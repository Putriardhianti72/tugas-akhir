...
class AdminSalesRecapController extends Controller
{
    ...
    public function export(Request $request)
    {
        ...
        return Excel::download(new SalesRecapExport($orders), 'sales-recap.xlsx');
        return (new SalesRecapExport($orders))->download('sales-recap.xlsx', \Maatwebsite\Excel\Excel::XLSX);
    }
    /**
